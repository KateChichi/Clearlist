...
//this function works for all CSVs !!except SETTLED!!, adding a new one for that called convertToCSV
...
function convertToCSVandCreateFilesToFoldersSETTLEDONLY(fileToConvertCsv, rangeInTab, fileOutputFolderId1, fileOutputFolder1Name, fileOutputFolderId2, ledgerRange, ledgerOutputRange, ledgerOutputFilter,ledgerOutputColFilter, ledgerInsertValueCol) {
...
function downloadSettledTradesCSVCL(){
  convertToCSVandCreateFilesToFoldersSETTLEDONLY(clearlistTradesLedger, rangeInTradeTab, bauFolderId, todaytradeoutputFolderName, masterOutgoingFolderId,todayTradeRangeSettled,todayTradeOutputRange,todayTradeOutputSettledFilter, todayTradeOutputColSettledFilter, todayTradeInsertValueColSettled)
}

function downloadSettledTradesCSVSN(){
  convertToCSVandCreateFilesToFoldersSETTLEDONLY(sharenettTradesLedger, rangeInTradeTab, bauFolderId, todaytradeoutputFolderName, masterOutgoingFolderId,todayTradeRangeSettled,todayTradeOutputRange,todayTradeOutputSettledFilter, todayTradeOutputColSettledFilter, todayTradeInsertValueColSettled)
}
